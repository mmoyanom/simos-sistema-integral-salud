...
public class MedicineSelectableListAdapter extends ArrayAdapter<Medicamento>{

	private List<Medicamento> items;
	
	public MedicineSelectableListAdapter(Context context, int textViewResourceId,
